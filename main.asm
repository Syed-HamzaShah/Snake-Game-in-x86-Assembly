...
PromptScreen PROC
    cmp showPrompt, 1
    jne SkipPrompt     ; If flag is not 1, skip prompt
    ...
    ; Move cursor to middle of the screen (e.g., column 35, row 12)
    mov dl, 35
    mov dh, 12
    call Gotoxy
...
PlayGame:
    mov showPrompt, 0      ; Mark prompt done
    ret                    ; Return to MAIN — clear screen there!
